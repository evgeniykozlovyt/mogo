...
let commentsSlider = new Swiper('.comments__slider', {
	/*
	// effect: 'fade',
	autoplay: {
		delay: 3000,
...
$('.spollers-do__spoller').click(function() {
	if (!$(this).hasClass("_active")) {
		$($(this).children()[1]).addClass('_active');
	} else {
		$($(this).children()[1]).removeClass('_active');
	}
})

$(".item-team__image-block").mouseenter(function() {
	$($(this).children()[0]).addClass('_active');
});

$(".item-team__image-block").mouseleave(function() {
	$($(this).children()[0]).removeClass('_active');
});

$(".item-team__image-block").mouseenter(function() {
	$($($(this).children()[0]).children()[1]).addClass('_active');
});

$(".item-team__image-block").mouseleave(function() {
	$($($(this).children()[0]).children()[1]).removeClass('_active');
});
